...
/* ************************************************************
                        NOTES
************************************************************ */
// About Section 2 - Narrative cards
// Displays eyebrow/title/description and grid of story blocks
// Uses colored background cards with icons matching Section4 styling
...
interface Section2Props {
    introduction: AboutUsPageContent["introduction"];
}

/* ************************************************************
                        COMPONENTS
************************************************************ */
export default function Section2({ introduction }: Section2Props) {
    /* ************************************************************
                            HOOKS
    ************************************************************ */
    ...
    /* ************************************************************
                            FUNCTIONS
    ************************************************************ */
    const blocks = (introduction?.blocks || []).map((block, index) => {
