        ...
        >
          <div className="max-w-xl">
            <motion.h1
              ...
              className={`text-brand-black mb-11 leading-none ${content.heroTitleBold ? "h1-bold" : "h1"}`}
            >
              <RenderLineBreaks text={content.heroTitle} />
            </motion.h1>
            <motion.p
              variants={paragraphVariants}
              className={`text-left w-full !leading-tight mb-6 ${content.heroParagraphBold ? "p-bold" : "p"}`}
            >
