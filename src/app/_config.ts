...
export const homePageFallbackData: HomePageProps = {
  ...
  slug: "home",
  content: {
    heroImageDesktop: "/images/homehero.png",
    heroImageMobile: "/images/heromob.png",
    section1Images: {
      icon1: "/images/file.svg",
      icon2: "/images/globe.svg",
      icon3: "/images/window.svg",
      icon4: "/images/next.svg",
    },
    descriptionHero:
    ...
    section2ImageDesktop: "/images/pill.png",
    section2ImageMobile: "/images/pillMob.png",
    ...
    section4ImageDesktop: "/images/pill.png",
    section4ImageMobile: "/images/pillMob.png",
    section3paragraph:
    ...
    section5icon1: "/images/next.svg",
    section5listText1: "Gluten Free",
    section5icon2: "/images/next.svg",
    section5listText2: "Vegan",
    section5icon3: "/images/next.svg",
    section5listText3: "Halal",
    section5icon4: "/images/next.svg",
    section5listText4: "Kosher",
    section5icon5: "/images/next.svg",
    section5listText5: "Guaranteed High-Quality",
    section5icon6: "/images/next.svg",
    section5listText6: "TGA-Listed",
    section5icon7: "/images/next.svg",
    section5listText7: "Proprietary Formula",
    section5icon8: "/images/next.svg",
    ...
    section5DetailImage: "/images/next.svg",
    section5FeatureImage: "/images/next.svg",
    section6title: "As Featured In",
    section6logos: ["/images/next.svg", "/images/vercel.svg"],
    ...
    section11Image: "/images/next.svg",
  },
};
